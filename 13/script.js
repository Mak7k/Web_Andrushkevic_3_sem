    ...
    contents.onclick = function(event) {
      ...
      var Sum=0;
      let storageMock = [
      {id: 1, name: "Рик (торговля не законна)", price: 10000, amount: 1},
      {id: 2, name: "Морти (торговля не законна)", price: 1, amount: 1},
      {id: 3, name: "Портальная пушка", price: 1425000, amount: 1},
      {id: 4, name: "Портальная жидкость", price: 150000, amount: 1},
      {id: 5, name: "Мегасемена", price: 145, amount: 1}];
